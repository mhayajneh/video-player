...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{route('adminPanel')}}">Videos</a>
...
<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="{{route('videos.index')}}">Videos list</a>
                <a class="dropdown-item" href="{{route('videos.create')}}">Videos create</a>
            </div>
        </li>
